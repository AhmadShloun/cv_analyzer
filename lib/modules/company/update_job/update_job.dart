...
class UpdateJobCompany extends StatelessWidget {
  ...
  var statusJobController = TextEditingController();
  var formKey = GlobalKey<FormState>();

  String? selectedSalutation;
  String? name;
  DataModelJob? compModel;

  UpdateJobCompany({super.key, model}) {
    compModel = model;
    subjectController.text = compModel!.subject!;
    skillsController.text = compModel!.requiredSkills!;
    workExperienceController.text=compModel!.requiredWorkExperience.toString() ;
    softSkillsController.text = compModel!.requiredSoftSkills!;
    languagesController.text = compModel!.requiredLanguages!;
    dateController.text = compModel!.expireTime!;
    statusJobController.text = compModel!.status!;
  }
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Center(
                              child: DropdownButtonFormField(
                                value: statusJobController.text,
                                items:

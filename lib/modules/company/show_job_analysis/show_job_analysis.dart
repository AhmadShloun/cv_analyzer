...
import 'package:cv_analyzer/modules/company/show_single_job_analysis/show_single_job_analysis.dart';
...
class ShowJobAnalysis extends StatelessWidget {
  const ShowJobAnalysis({super.key});
      ...
      child: BlocConsumer<CompanyCubit, CompanyStates>(
        ...
        builder: (context, state) {
          return ConditionalBuilder(
            condition: CompanyCubit.get(context).showJobAnalyzesModel != null,
            builder: (context) => builderHomeCompany(CompanyCubit.get(context).showJobAnalyzesModel!,context),
...
Widget buildJobItem(DataJobAnalysisShow model,context)=>SingleChildScrollView(
